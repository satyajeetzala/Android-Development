...
public class MainActivity extends AppCompatActivity {
    ...
    private void deleteRecord() {
        ...
        if (!idStr.isEmpty()) {
            int id = Integer.parseInt(idStr);
            dbHelper.deleteRecord(new Record(id, "", ""));
    ...
    private void viewRecords() {
        ...
        for (Record record : records) {
            stringBuilder.append("ID: ").append(record.getId()).append(", Name: ").append(record.getName()).append(", Email: ").append(record.getEmail()).append("\n");
        }
